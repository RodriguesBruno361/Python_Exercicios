...
l_peso = Label(frame_baixo, text= 'Informe o seu peso: ', height=1, padx=0, relief='flat', anchor='center', font=('Ivy 10 bold'), bg = co0, fg = co1)
...
l_altura = Label(frame_baixo, text= 'Informe a sua altura: ', height=1, padx=0, relief='flat', anchor='center', font=('Ivy 10 bold'), bg = co0, fg = co1)
...
l_resultado = Label(frame_baixo, text= '---',width=5, height=1, padx=1, pady=6, relief='flat', anchor='center', font=('Ivy 24 bold'), bg = co2, fg = co0)
l_resultado.place(x=193, y=15)

l_resultado_texto = Label(frame_baixo, text= '',width=37, height=1, padx=1, pady=6, relief='flat', anchor='center', font=('Ivy 10 bold'), bg = co0, fg = co1)
